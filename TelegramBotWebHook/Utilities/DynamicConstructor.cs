namespace TelegramBotWebHook.Utilities
{
    ...
    {
        //public static DynamicConstructor GetDynamicConstructor<T>(Type type)
        //{
        //    ConstructorInfo[] originalCtors = typeof(T).GetConstructors();
            
        //    foreach (var originalCtor in originalCtors)
        //    {
